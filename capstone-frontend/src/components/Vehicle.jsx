            ...
            colors: [
                {
                    ...
                    wheels: [
                        ...
                        { name: "Bronze", images: Array.from({ length: 12 }, (_, i) => `/nissan/te3/black/bronze-wheel/${i + 1}.png`) },
                        { name: "Gunmetal", images: Array.from({ length: 12 }, (_, i) => `/nissan/te3/black/gunmetal-wheel/${i + 1}.png`) },
                    ],
                },
                {
                    name: "Brown",
